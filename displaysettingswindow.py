...
class TDisplaySettingsWindow(simpledialog.Dialog):
    ...
    def __init__(self, master, tickintx = 1.0, tickinty = 1.0, round_digits = 2, \
                 ...
                 max_model_y = 10.0, fit_to_window = True):
    ...
    def body(self, master):
        ...
        Label(self.body_frame, text = "x tick interval:", anchor = W).grid(row = 0, sticky = EW)
        Label(self.body_frame, text = "y tick interval:", anchor = W).grid(row = 1, sticky = EW)
        Label(self.body_frame, text = "Label decimal precision:", anchor = W).grid(row = 2, sticky = EW)
        ...
        Label(self.body_frame, text = "Shapes fill", anchor = W).grid(row = 3, column = 0, sticky = EW)
        ...
        self.toggle_fill.grid(row = 4, columne = 1, sticky = EW, padx = 5)
    ...
    def apply (self):
        ...
        try:
            ...
            self.result = tickintx, tickinty, round_digits, fill#, min_model_x, \
